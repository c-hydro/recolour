...
"""
RECOLOUR APP - WEIGHTS  - REprocess paCkage for sOiL mOistUre pRoducts
...
python app_map_weights.py -settings_file configuration.json

Version(s):
20230824 (1.0.0) --> First development
"""
...
alg_name = 'Application for computing product weights'
alg_type = 'Package'
alg_version = '1.0.0'
alg_release = '2023-08-24'
# -------------------------------------------------------------------------------------
