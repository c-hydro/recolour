...
script_file_app='app_map_grid_tc_nrt.py'
script_folder_settings='/home/hsaf/recolour/app/app_map/create_grid_tc/'

script_file_settings='app_map_grid_tc_nrt.json'
...
time_now="2022-01-16 23:00" # complete period

# Time period execution
# "dr :: 2016-01-01 -- 2023-09-20 (2820 days)"
time_period_days=2208 # fix on 0 to provide actual time only, if providing a time period always add 1
#-----------------------------------------------------------------------------------------
