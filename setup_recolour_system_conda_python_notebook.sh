...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR ENVIRONMENT - PYTHON3 LIBRARIES FOR PACKAGE - NOTEBOOK TYPE - CONDA'
...
fp_env_tag_default='recolour_notebook'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	conda create --yes --name $fp_env_folder_libraries numpy scipy pandas seaborn matplotlib=3.1.3 rasterio geopandas cartopy=0.17 netCDF4 pip jupyterlab ipywidgets ipympl nodejs=12 python=3.7
	echo " ======> [1/3] CONDA-DEFAULT CHANNEL INSTALLATION ... DONE"
	
	echo " ======> [2/3] PYTHON-PIP INSTALLATION ... "
	source activate $fp_env_folder_libraries
	pip install cmcrameri
	pip install pygeogrids
	pip install pytesmo==0.13.4
	echo " ======> [2/3] PYTHON-PIP INSTALLATION ... DONE"
	
	echo " ======> [3/3] JUPYTER-NOTEBOOK INSTALLATION ... "
    jupyter labextension install @jupyter-widgets/jupyterlab-manager
    jupyter lab build
    echo " ======> [3/3] JUPYTER-NOTEBOOK INSTALLATION ... DONE"
