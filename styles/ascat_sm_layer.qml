...
<qgis version="3.18.3-Zürich" minScale="1e+08" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="100" band="1" type="singlebandpseudocolor" nodataColor="" opacity="1" classificationMin="0" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader minimumValue="0" classificationMode="2" labelPrecision="4" clip="0" maximumValue="100" colorRampType="INTERPOLATED">
          ...
          <item label="10,0000" color="#482475" value="10" alpha="255"/>
          <item label="20,0000" color="#404387" value="20" alpha="255"/>
          <item label="30,0000" color="#345f8d" value="30" alpha="255"/>
          <item label="40,0000" color="#29788e" value="40" alpha="255"/>
          <item label="50,0000" color="#20908d" value="50" alpha="255"/>
          <item label="60,0000" color="#22a884" value="60" alpha="255"/>
          <item label="70,0000" color="#43bf70" value="70" alpha="255"/>
          <item label="80,0000" color="#7ad251" value="80" alpha="255"/>
          <item label="90,0000" color="#bcdf27" value="90" alpha="255"/>
          <item label="100,0000" color="#fde725" value="100" alpha="255"/>
