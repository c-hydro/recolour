...
<qgis version="3.18.3-Zürich" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" nodataColor="" type="singlebandpseudocolor" alphaBand="-1" classificationMax="100" classificationMin="0" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader maximumValue="100" minimumValue="0" classificationMode="2" clip="0" labelPrecision="4" colorRampType="INTERPOLATED">
          ...
          <item label="0,0000" alpha="255" color="#440154" value="0"/>
          <item label="10,0000" alpha="255" color="#482475" value="10"/>
          <item label="20,0000" alpha="255" color="#404387" value="20"/>
          <item label="30,0000" alpha="255" color="#345f8d" value="30"/>
          <item label="40,0000" alpha="255" color="#29788e" value="40"/>
          <item label="50,0000" alpha="255" color="#20908d" value="50"/>
          <item label="60,0000" alpha="255" color="#22a884" value="60"/>
          <item label="70,0000" alpha="255" color="#43bf70" value="70"/>
          <item label="80,0000" alpha="255" color="#7ad251" value="80"/>
          <item label="90,0000" alpha="255" color="#bcdf27" value="90"/>
          <item label="100,0000" alpha="255" color="#fde725" value="100"/>
