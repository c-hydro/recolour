...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR ENVIRONMENT - PYTHON3 LIBRARIES FOR PACKAGE - ADAPTER TYPE - CONDA'
script_version="1.6.4"
script_date='2024/04/09'
...
fp_env_tag_default='recolour_adapter_4_hyde'
