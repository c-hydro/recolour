...
cat << EOF > run_recolour_system_env_validation_hsaf.sh
#!/bin/bash
...
chmod +x run_recolour_system_env_validation_hsaf.sh

echo ""
echo "Environment created successfully"
echo ""
echo "To load the environment use:"
echo "source run_recolour_system_env_validation_hsaf.sh"
