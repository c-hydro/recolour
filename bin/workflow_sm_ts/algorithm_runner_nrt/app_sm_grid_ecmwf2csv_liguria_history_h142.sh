...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - CREATE ECMWF GRID2CSV TS - NRT - HISTORY H142'
...
script_file_settings='app_sm_grid_ecmwf2csv_liguria_history_h142.json'
...
time_now="2022-01-01 00:00" # history case from 2019-01-01 to 2021-12-31
