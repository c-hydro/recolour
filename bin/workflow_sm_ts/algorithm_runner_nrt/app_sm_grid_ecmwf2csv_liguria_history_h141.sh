...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - CREATE ECMWF GRID2CSV TS - NRT - HISTORY H141'
...
script_file_settings='app_sm_grid_ecmwf2csv_liguria_history_h141.json'
...
time_now="2019-01-01 00:00" # history case from 1992-01-01 to 2018-12-31

# Time period execution
time_period_months=96
#-----------------------------------------------------------------------------------------
