...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - CREATE ECMWF GRID2CSV TS - NRT - HISTORY H26'
...
script_file_settings='app_sm_grid_ecmwf2csv_liguria_history_h26.json'
...
time_now="2024-01-01 00:00" # history case from 2021-11 to now
