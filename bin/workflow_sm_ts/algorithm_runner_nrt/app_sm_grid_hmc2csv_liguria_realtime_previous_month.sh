...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - CREATE HMC GRID2CSV TS - NRT - REALTIME - PREVIOUS MONTH'
script_version="1.2.0"
script_date='2024/02/29'

# Script settings
script_folder_app='/share/home/idrologia/package/package_recolour/app/app_ts/convert_grid_hmc2csv/'
script_file_app='app_sm_grid_hmc2csv.py'
script_folder_settings='/share/home/idrologia/project/sm_ts/algorithm_runner/'
script_file_settings='app_sm_grid_hmc2csv_liguria_realtime_previous_month.json'
