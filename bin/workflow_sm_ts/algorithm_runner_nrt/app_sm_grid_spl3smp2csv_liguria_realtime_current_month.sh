...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - CREATE SPL3SMP GRID2CSV TS - NRT - REALTIME - CURRENT MONTH'
...
script_file_settings='app_sm_grid_spl3smp2csv_liguria_realtime_current_month.json'
