...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - TIME SERIES ECMWF LAYER 0-7 CM - DATA RECORD - HISTORY'
...
script_file_settings='app_sm_ts_join_periods_ecmwf_layer_0_7_cm_liguria_history.json'
