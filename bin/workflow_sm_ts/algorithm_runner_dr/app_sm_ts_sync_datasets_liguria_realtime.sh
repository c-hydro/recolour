...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - TIME SERIES HMC - SYNC DATA RECORD - REALTIME'
script_version="1.2.0"
script_date='2024/02/29'

# Script settings
script_folder_app='/share/home/idrologia/package/package_recolour/app/app_ts/sync_ts/'
script_file_app='app_sm_ts_sync.py'
script_folder_settings='/share/home/idrologia/project/sm_ts/algorithm_runner_dr/'
script_file_settings='app_sm_ts_sync_datasets_liguria_realtime.json'
