...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - TIME SERIES ECMWF LAYER 0-100 CM - DATA RECORD - HISTORY'
...
script_file_settings='app_sm_ts_join_periods_ecmwf_layer_0_100_cm_liguria_history.json'
