...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - IMG2CELL - HMC - NRT HISTORY'
script_version="1.5.0"
script_date='2023/09/18'

# Script settings
script_folder_app='/home/idrologia/package/package_recolour/app/app_cell/convert_img2cell/hmc/'
script_file_app='app_img2cell_hmc.py'
script_folder_settings='/home/idrologia/project/sm_tc/app_cell/convert_img2cell/hmc/'
script_file_settings='app_img2cell_hmc_nrt_history.json'
...
time_now="2024-01-29 23:00"

# Time period execution
# "dr :: 2008-01-01 -- 2023-09-20 (5741 days)"
time_period_days=4 # 5741 # fix on 0 to provide actual time only, if providing a time period always add 1
#-----------------------------------------------------------------------------------------
