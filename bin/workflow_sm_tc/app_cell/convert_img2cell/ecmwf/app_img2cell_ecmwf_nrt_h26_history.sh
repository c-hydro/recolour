...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - IMG2CELL - H26 - NRT - HISTORY'
...
script_file_settings='app_img2cell_ecmwf_nrt_h26_history.json'
...
time_now="2023-12-01 00:00" # debug

# Time period execution
# "dr :: 2022-01-01 -- 2023-09-20 (626 days)"
time_period_days=90 # fix on zero to provide actual time only, if providing a # days always add 1
#-----------------------------------------------------------------------------------------
