...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - IMG2CELL - H26 - NRT - REALTIME'
...
script_folder_settings='/home/idrologia/project/sm_tc/app_cell/convert_img2cell/ecmwf/'
script_file_settings='app_img2cell_ecmwf_nrt_h26_realtime.json'
...
time_period_days=4 # fix on zero to provide actual time only, if providing a # days always add 1
#-----------------------------------------------------------------------------------------
