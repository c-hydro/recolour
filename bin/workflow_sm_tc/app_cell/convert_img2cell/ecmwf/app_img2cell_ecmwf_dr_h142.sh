...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - IMG2CELL - H142 - DATA RECORD'
...
script_file_settings='app_img2cell_ecmwf_dr_h142.json'
...
time_now="2021-12-31 18:00" # complete period

# Time period execution
# "dr :: 2019-01-01 -- 2021-12-31 (1095 days)"
time_period_days=1095 # fix on zero to provide actual time only, if providing a # days always add 1
#-----------------------------------------------------------------------------------------
