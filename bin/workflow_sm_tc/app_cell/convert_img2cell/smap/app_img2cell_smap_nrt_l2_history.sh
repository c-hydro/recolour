...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - IMG2CELL - SMAP L2 - NRT REALTIME'
script_version="1.5.0"
script_date='2023/09/18'

# Script settings
script_folder_app='/home/idrologia/package/package_recolour/app/app_cell/convert_img2cell/smap/'
script_file_app='app_img2cell_smap.py'
script_folder_settings='/home/idrologia/project/sm_tc/app_cell/convert_img2cell/smap/'
script_file_settings='app_img2cell_smap_nrt_l2_history.json'
...
time_now="2024-01-29 23:00" # complete period

# Time period execution
# "dr :: 2016-01-01 -- 2023-09-20 (2820 days)"
time_period_days=5 # fix on 0 to provide actual time only, if providing a time period always add 1
#-----------------------------------------------------------------------------------------
