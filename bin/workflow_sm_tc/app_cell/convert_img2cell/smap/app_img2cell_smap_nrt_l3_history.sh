...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - IMG2CELL - SMAP L3 - NRT HISTORY'
...
script_file_settings='app_img2cell_smap_nrt_l3_history.json'
...
time_now="2024-01-29 00:00" # complete period

# Time period execution
# "dr :: 2016-01-01 -- 2023-09-20 (2820 days)"
time_period_days=4 # fix on 0 to provide actual time only, if providing a time period always add 1
#-----------------------------------------------------------------------------------------
