...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - DOWNLOADER - SOIL MOISTURE SMAP L3 - NRT REALTIME'
script_version="3.1.1"
script_date='2024/01/22'

# Script settings
script_folder_app='/home/idrologia/package/package_recolour/tools/algorithm_downloader/smap/l3/'
script_file_app='smap_downloader_spl3smp_e.py'
script_folder_settings='/share/home/idrologia/project/sm_tc/tools/algorithm_downloader/smap/l3/'
script_file_settings='smap_downloader_spl3smp_e_nrt_realtime.json'
