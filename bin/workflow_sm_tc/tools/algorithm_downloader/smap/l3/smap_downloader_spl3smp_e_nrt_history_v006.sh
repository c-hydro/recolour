...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - DOWNLOADER - SOIL MOISTURE SMAP L3 - NRT - HISTORY (V006)'
...
script_file_settings='smap_downloader_spl3smp_e_nrt_history_v006.json'
...
time_now="2023-12-04 00:00" # from 2023-12-04 to now
#-----------------------------------------------------------------------------------------
