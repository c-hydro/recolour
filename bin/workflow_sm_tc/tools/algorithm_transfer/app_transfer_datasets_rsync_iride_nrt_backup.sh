...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - TRANSFER DATASETS - IRIDE - NRT BACKUP'
...
settings_file=${configuration_folder}'app_transfer_datasets_rsync_iride_nrt_backup.json'

# Get information (-u to get gmt time)
time_now=$(date -u +"%Y-%m-%d %H:00")
# time_now="2024-03-12 12:00"
#-----------------------------------------------------------------------------------------
