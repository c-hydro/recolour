...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - CREATE MAP TC PRODUCT - NRT - REALTIME'
...
script_file_settings='app_map_grid_tc_hmc_nrt_realtime.json'
...
#time_now="2024-03-12 12:00" # history hmc ref
