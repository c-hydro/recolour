...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - IMG2CELL - H26 - DATA RECORD'
script_version="1.5.0"
script_date='2023/09/19'

# Script settings
script_folder_app='/home/idrologia/package/package_recolour/app/app_cell/convert_img2cell/ecmwf/'
script_file_app='app_img2cell_ecmwf.py'
script_folder_settings='/home/idrologia/project/validation_hsaf/algorithm_runner/convert_img2cell/'
script_file_settings='app_img2cell_ecmwf_dr_h26.json'
...
time_now="2023-05-31 00:00" # complete period

# Time period execution
# "dr :: 1992-01-01 -- 2018-12-31 (from 2008-01-01, 4018 days)"
time_period_days=0 # fix on zero to provide actual time only, if providing a # days always add 1
#-----------------------------------------------------------------------------------------
