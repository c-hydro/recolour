...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - IMG2CELL - CCI - DATA RECORD '
script_version="1.5.0"
script_date='2023/09/18'

# Script settings
script_folder_app='/home/idrologia/package/package_recolour/app/app_cell/convert_img2cell/cci/'
script_file_app='app_img2cell_cci.py'
script_folder_settings='/home/idrologia/project/validation_hsaf/algorithm_runner/convert_img2cell/'
script_file_settings='app_img2cell_cci_dr.json'
