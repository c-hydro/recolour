...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR RUNNER - HSAF ASCAT H103 [METOP-SM] HISTORY - DR'
...
script_folder_settings='/share/home/idrologia/project/sm_obs_mod/algorithm_runner/'
script_file_settings='app_swath2cell_ascat_h103_dr.json'
