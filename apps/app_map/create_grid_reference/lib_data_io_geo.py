...
def read_grid_data(file_name, output_format='data_array', output_dtype='float32',
    ...
    try:
        ...
        data_attrs = {'file_transform': transform, 'file_crs': crs, 'file_proj': var_proj,
                      'file_bbox': [bounds.left, bounds.bottom, bounds.right, bounds.top],
                      'file_bb_left': bounds.left, 'file_bb_right': bounds.right,
                      'file_bb_top': bounds.top, 'file_bb_bottom': bounds.bottom,
                      'file_res_x': res[0], 'file_res_y': res[1],
                      'file_high': height, 'file_wide': width}
