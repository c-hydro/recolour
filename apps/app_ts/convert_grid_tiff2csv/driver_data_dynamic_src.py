        ...
        if not os.path.exists(file_path_anc_def):
            ...
            for time_step in time_obj:
                ...
                if os.path.exists(file_path_src_step):
                    ...
                    if self.format_src == 'tiff_grid':

                        # method to get data
                        grid_data, grid_attrs, grid_geo_x, grid_geo_y, geo_attrs = read_file_tiff(file_path_src_step)
                        ...
                        grid_obj_da = convert_dataset_to_data_array(grid_obj_dset_def)
                    ...
                    point_data = extract_data_grid2point(
                        grid_obj_da, grid_obj_geo, point_obj_geo,
