...
"""
RECOLOUR APP - TIME-SERIES POINT MAT 2 CSV  - REprocess paCkage for sOiL mOistUre pRoducts
...
python app_sm_ts_mat2csv.py -settings_file configuration.json
...
alg_name = 'Application for making time-series source 2 csv'
alg_type = 'Package'
alg_version = '1.0.0'
