...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR ENVIRONMENT - PYTHON3 LIBRARIES FOR PACKAGE - XML TYPE - CONDA'
...
fp_env_tag_default='recolour_xml'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	conda create --yes --name $fp_env_folder_libraries numpy scipy gdal affine h5py pandas rasterio xarray pip python=3.8
