...
"""
RECOLOUR TOOLS - ASCAT SWATH2TS - tRiplE Collocation sOiL mOistUre pRoduct
...
python app_swath2ts_ascat.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"
...
from lib_info_args import logger_name, logger_file, logger_format
