...
script_file_settings='app_validation_italy_hmc_ecmwf_smap_1357.json'
...
echo " ==> COMMAND LINE: python "$script_file_app""
python $script_path_app -settings_file $script_file_settings
