...
"""
RECOLOUR TOOLS - HMC GRID2TS - REprocess paCkage for sOiL mOistUre pRoducts
...
python app_grid2ts_hmc.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"
