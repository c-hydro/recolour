...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR ENVIRONMENT - PYTHON3 LIBRARIES FOR PACKAGE - PUBLISHER TYPE - CONDA'
...
fp_env_tag_default='recolour_publisher'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	conda create --yes --name $fp_env_folder_libraries numpy scipy pandas matplotlib=3.1.3 rasterio geopandas cartopy=0.17 netCDF4 pip python=3.7
