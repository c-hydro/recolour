...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR RUNNER - APP VALIDATION - HISTORY'
...
script_file_settings='app_validation_italy_ascat_hmc_smap.json'
...
python $script_file_app -settings_file $script_path_settings # -time $time_now
