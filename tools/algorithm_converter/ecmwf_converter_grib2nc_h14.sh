...
# ----------------------------------------------------------------------------------------
# Script information
script_name='ECMWF H14 FILES CONVERTER [GRIB 2 NC]'
...
file_in_raw="h14_%YYYY%MM%DD_0000.grib"
file_tmp_raw="h14_%YYYY%MM%DD_00_r.grib"
file_out_raw="rzsm_%YYYY%MM%DD00_h14.nc"

# Folder(s) information
folder_in_raw="/share/HSAF_Data_Validation/datasets/hsaf_mod_grid/h14_grib/%YYYY/%MM/%DD/"
folder_tmp_raw="/share/HSAF_Data_Validation/datasets/hsaf_mod_grid/h14_grib/h14_tmp/%YYYY/%MM/%DD/"
folder_out_raw="/share/HSAF_Data_Validation/datasets/hsaf_mod_grid/h14_nc/%YYYY/%MM/%DD/"

# Folder(s) information
# folder_in_raw="/share/HSAF_Data_Validation/datasets/hsaf_mod/h14_grib/%YYYY/%MM/%DD/"
# folder_tmp_raw="/share/HSAF_Data_Validation/datasets/hsaf_mod/h14_tmp/%YYYY/%MM/%DD/"
# folder_out_raw="/share/HSAF_Data_Validation/datasets/hsaf_mod/h14_nc/%YYYY/%MM/%DD/"
