...
# ----------------------------------------------------------------------------------------
# Script information
script_name='ECMWF H140 FILES CONVERTER [GRIB 2 NC]'
...
file_in_raw="h140_%YYYY%MM%DD00.grib"
file_tmp_raw="h140_%YYYY%MM%DD_00_r.grib"
file_out_raw="rzsm_%YYYY%MM%DD00_dr.nc"

# Folder(s) information
folder_in_raw="/share/HSAF_Data_Validation/datasets/hsaf_mod/h140_grib/%YYYY/%MM/%DD/"
folder_tmp_raw="/share/HSAF_Data_Validation/datasets/hsaf_mod/h140_tmp/%YYYY/%MM/%DD/"
folder_out_raw="/share/HSAF_Data_Validation/datasets/hsaf_mod/rzsm_dr_nc/%YYYY/%MM/%DD/"
