...
script_name='RECOLOUR - CONVERTER - PRODUCT SOIL MOISTURE ECMWF-RZSM'
script_version="2.0.0"
script_date='2023/08/03'

# executable(s)
# exec_cdo="/home/fabio/Desktop/Apps/cdo-1.9.6_NC-4.6.0_HDF-1.8.17_ECCODES-2.12.5/bin/cdo" # local
exec_cdo="/home/hsaf/recolour/library/cdo/bin/cdo" # local
# exec_cdo="/home/hsaf/library/cdo-1.7.2rc3_NC-4.1.2_HDF-1.8.17/bin/cdo" # server
exec_ncap2="/home/fabio/fp_system_apps/nco/bin/ncap2" # NOT FOUND
exec_ncks="/home/fabio/fp_system_apps/nco/bin/ncks" # NOT FOUND
