...
"""
RECOLOUR TOOLS - SMAP GRID2TS - REprocess paCkage for sOiL mOistUre pRoducts
...
def main_wrapper():
    ...
    create_file_grid(
        ...
        data_ext='.tiff', grid_update=data_settings['flags']['reset_static']
    )
    # -------------------------------------------------------------------------------------
