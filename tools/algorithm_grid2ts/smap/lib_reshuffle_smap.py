...
from lib_img2ts_smap import Img2Ts
from lib_interface_smap import smap_ds
from lib_grid_smap import load_grid, subgrid4bbox
# -------------------------------------------------------------------------------------
...
def reshuffle(product,
    ...
    # get data of start date of the period
    delta = timedelta(hours=6)
    data = dataset_grid_driver.read(start_date+delta)
