...
class CplDatasets:
    ...
    def __init__(self, dset_collections_src, dset_collections_dst,
                 tag_dset_reference='reference', tag_dset_k1='k1', tag_dset_k2='k2'):
        ...
        if self.dimensions == 2:
            self.dset_mode = ['reference', 'other']
            self.dset_tag = [tag_dset_reference, tag_dset_k1]
        elif self.dimensions == 3:
            self.dset_mode = ['reference', 'other', 'other']
    ...
    def setup_datasets_src(self):
        ...
        for dset_id, (dset_mode, dset_tag) in enumerate(zip(self.dset_mode, self.dset_tag)):
            ...
            dset_interfaces[dset_name] = dset_interface
            dset_modes[dset_name] = dset_modes
