...
# Script settings
script_folder_app='/home/hsaf/recolour/tools/algorithm_downloader/smap/l2_nrt/'
script_file_app='smap_downloader_spl2smp_e.py'
script_folder_settings='/home/hsaf/recolour/tools/algorithm_downloader/smap/l2_nrt/'

script_file_settings='smap_downloader_spl2smp_e.json'
