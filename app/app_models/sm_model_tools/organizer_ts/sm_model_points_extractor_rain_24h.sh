...
# -----------------------------------------------------------------------------------------
# Script information
script_name='SM MODEL GRID - ORGANIZER TS - RAIN - HISTORY (24h)'
...
fp_settings="/hydro/fp_tools_postprocessing/analyzer_sm_cnr/model_grid/organizer_ts/sm_model_points_extractor_rain_history_24h.json"

# Lock folder/file
folder_lock="/hydro/lock/sm_cnr"
fp_lock="${folder_lock}/run_extract_points_rain_history_24h.lock"
