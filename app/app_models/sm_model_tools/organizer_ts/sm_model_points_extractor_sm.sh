...
# -----------------------------------------------------------------------------------------
# Script information
script_name='SM MODEL POINTS EXTRACTOR - SM - REALTIME'
...
fp_settings="/hydro/library/fp_package_connectors/sm_model_tools/sm_model_points_extractor_sm.json"

# Lock folder/file
folder_lock="/hydro/lock/sm_cnr"
fp_lock="${folder_lock}/run_extract_points_sm.lock"
