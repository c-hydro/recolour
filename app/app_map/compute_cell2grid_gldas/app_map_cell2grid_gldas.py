...
"""
RECOLOUR APPS - CELL2GRID GLDAS - REprocess paCkage for sOiL mOistUre pRoducts
...
python app_map_cell2grid_gldas.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version(s):
20240418 (1.0.0) --> First development
"""
...
alg_name = 'Application for resampling cells 2 grid gldas'
alg_type = 'Package'
alg_version = '1.0.0'
alg_release = '2024-04-18'
# -------------------------------------------------------------------------------------
