...
"""
RECOLOUR APPS - CELL2GRID SMAP - REprocess paCkage for sOiL mOistUre pRoducts
...
python app_map_cell2grid_smap.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version(s):
20240422 (1.0.0) --> First development
"""
...
alg_name = 'Application for resampling cells 2 grid smap'
alg_type = 'Package'
alg_version = '1.0.0'
