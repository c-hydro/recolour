        ...
        for alg_time_group in self.alg_time_datasets:
            ...
            if not os.path.exists(file_path_anc_map_step):
                ...
                if fx_active_common_update and fx_active_common_update:
                    # call update method
                    obj_data_map_update = fx_handle_common_update(
                        obj_data_map_filter,
                        cell_obj=obj_data_cell_merge,
                    ...
                    # info end update datasets
                    obj_data_map_update = deepcopy(obj_data_map_filter)
                ...
                if fx_active_common_mask and fx_active_common_mask:
                    ...
                    obj_data_map_mask = fx_handle_common_mask(
                        obj_data_map_update, grid_geo_data,
                    ...
                    # info end mask datasets
                    obj_data_map_mask = deepcopy(obj_data_map_update)
