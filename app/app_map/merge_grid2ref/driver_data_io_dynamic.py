                        ...
                        if os.path.exists(var_file_path_anc):
                            ...
                            if var_dset_masked:
                                ...
                                if file_type_dst == 'netcdf':
                                    ...
                                    var_file_obj_tmp = deepcopy(var_file_dict_dst)

                                    if not isinstance(var_file_obj_tmp, dict):
                                    ...
                                    var_file_name_list, var_file_obj_dst = [], {}
                                    for var_name, var_file_path_dst in var_file_obj_tmp.items():

                                        if var_name in list(var_dset_masked.data_vars):
                                            ...
                                            var_file_obj_dst[var_name] = var_file_path_dst

                                        else:
                                            log_stream.warning(
                                                ' ===> Variable "' + var_name +
                                                '" is not in the destination dataset. '
                                                'Check if it is defined in variable group destination')
                                    ...
                                    if var_file_obj_dst:
                                        ...
                                        log_stream.info(' ------> Save datasets group  ... SKIPPED. No datasets to save')
