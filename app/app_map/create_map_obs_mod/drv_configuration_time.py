...
from lib_info_args import logger_name, time_format
...
class DataTime:
    ...
    def __getTimeNow(self):
        ...
        try:
            ...
            log_stream.error(' =====> ERROR: time now definition failed! Check your data and settings!')
            raise RuntimeError('The variable time now must be defined')
        return time_now
    ...
    def __getTimeArg(self):
        ...
        try:
            ...
            log_stream.error(' =====> ERROR: time argument definition failed! Check your data and settings!')
            raise RuntimeError('The variable time argument must be defined')
