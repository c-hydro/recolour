"""
RECOLOUR APP - PROCESSING TOOL - SOIL MOISTURE PRODUCT MOD DR [ECMWF - RZSM]
...
python3 app_sm_mod_dr_ecmwf.py -settings_file configuration_product.json -time YYYYMMDDHHMM
...
def main():
    ...
    alg_name = 'ECMWF MOD - Data Record'
