...
from lib_organizer_mod_base import AscatOrganizerNRT, AscatOrganizerDataRecord
...
class DataProductWrapper:
    ...
    def execDataRecord(self):
        ...
        if not check_filename(self.ascat_organizer.ascat_path_analysis, self.filepath_grid_ref_global,
            ...
            log_stream.info(' ----> Create dr analysis data ... DONE')
        else:
            log_stream.info(' ----> Create dr analysis data ... PREVIOUSLY CREATED')
