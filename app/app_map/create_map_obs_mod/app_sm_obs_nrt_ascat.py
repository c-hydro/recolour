...
python3 app_sm_obs_nrt_ascat.py -settings_file configuration_product.json -time YYYYMMDDHHMM
...
def main():
    ...
    log_stream.info(' --> Set grid domain ... DONE'); print(data_algorithm_time['time_steps'])
    # -------------------------------------------------------------------------------------
    ...
    for time_step in data_algorithm_time['time_steps']:
        ...
        driver_dynamic_product.resampleDataProduct()
