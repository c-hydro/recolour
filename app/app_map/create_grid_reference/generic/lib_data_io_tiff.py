...
def organize_file_tiff(obj_variable, obj_time=None,
    ...
    var_attributes = {
        ...
        'file_transform': var_geo_transform, 'file_proj': proj_epsg,
...
def write_file_tiff(file_name, file_data, file_wide, file_high, file_transform, file_proj,
                    file_metadata=None, file_format=gdalconst.GDT_Float32, **kwargs):
