...
"""
RECOLOUR APP - SM RESCALED GRID PRODUCT  - REprocess paCkage for sOiL mOistUre pRoducts
...
Version(s):
20240625 (6.0.0) --> Refactor and update codes to recolour package
...
from drv_data_static import DrvData as DrvStatic
from drv_data_dynamic import DrvData as DrvDynamic
...
alg_name = 'Application for computing grid rescaled soil moisture product'
alg_type = 'Package'
alg_version = '6.0.0'
alg_release = '2024-06-25'
# -------------------------------------------------------------------------------------
...
def main():
    ...
    drv_data_static = DrvStatic(alg_data_settings)
    ...
    drv_data_dynamic = DrvDynamic(alg_time_run, alg_data_static, alg_data_settings)
    # compute datasets
    collections_data_dynamic = drv_data_dynamic.compute_data()
    # analyze datasets
    collections_data_dynamic = drv_data_dynamic.analyze_data()
    # dump datasets
    collections_data_dynamic = drv_data_dynamic.dump_data()
    # -------------------------------------------------------------------------------------
