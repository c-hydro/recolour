#!/usr/bin/python3
"""
RECOLOUR APP - TIME-SERIES JOIN PRODUCTS  - REprocess paCkage for sOiL mOistUre pRoducts
__date__ = '20231016'
__version__ = '1.0.0'
...
python3 app_sm_ts_join_products.py
    -k1 {file_name}_product_1.csv
    -k2 {file_name}_product_2.csv
    -k3 {file_name}_product_3.csv
    -out {file_name}_products.csv
