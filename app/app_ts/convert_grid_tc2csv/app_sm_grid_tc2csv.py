...
"""
RECOLOUR APP - TIME-SERIES GRID TC 2 CSV  - REprocess paCkage for sOiL mOistUre pRoducts
...
python app_sm_grid_tc2csv.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"
...
alg_name = 'Application for making time-series grid tc 2 csv'
alg_type = 'Package'
alg_version = '1.0.0'
alg_release = '2023-10-10'
# -------------------------------------------------------------------------------------
