    ...
    def dump_obj_datasets(self, file_path_template, file_dframe_raw, file_time,
        ...
        if self.format_datasets == 'csv':
            ...
            if self.type_datasets == 'all_pnt_one_var':
                ...
                # info type start
                log_stream.info(' ------> Datasets "' + self.type_datasets + '" ... ')
                ...
                if not os.path.exists(file_path_defined):
                    ...
                    # info type start
                    log_stream.info(' ------> Datasets "' + self.type_datasets + '" ... SKIPPED')
                ...
                for point_name, point_dframe_raw in file_dframe_raw.items():
                    ...
                    if not os.path.exists(file_path_defined):
                        ...
                        # info point end
                        log_stream.info(' -------> Point "' + point_name + '" ... SKIPPED. File previously dumped.')
