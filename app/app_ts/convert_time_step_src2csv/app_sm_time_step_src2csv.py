...
"""
RECOLOUR APP - TIME-STEP POINT SOURCE 2 CSV  - REprocess paCkage for sOiL mOistUre pRoducts
...
alg_name = 'Application for making time-step point source 2 csv'
alg_type = 'Package'
alg_version = '1.0.0'
alg_release = '2024-07-03'
# -------------------------------------------------------------------------------------
