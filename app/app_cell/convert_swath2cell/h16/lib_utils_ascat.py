...
def create_file_grid(grid_path, data_path, data_ext='.tif', grid_update=True):
    ...
    logging.info(' ---> Create grid reference fr datasets ... ')
    ...
    if not os.path.exists(grid_path):
        ...
        logging.info(' ---> Create grid reference for HMC datasets ... DONE')

    else:
        logging.info(' ---> Create grid reference for HMC datasets ... PREVIOUSLY DONE')
