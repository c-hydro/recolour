...
"""
RECOLOUR APPS - COMPUTE RZSM - REprocess paCkage for sOiL mOistUre pRoducts
...
python app_cell_rzsm.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version(s):
20240506 (1.0.0) --> First development
"""
...
from drv_cell_static import DrvCell as DrvStatic
from drv_cell_dynamic import DrvCell as DrvDynamic
...
alg_name = 'Application for computing cell root-zone-soil-moisture'
alg_type = 'Package'
alg_version = '1.0.0'
alg_release = '2024-05-06'
# -------------------------------------------------------------------------------------
