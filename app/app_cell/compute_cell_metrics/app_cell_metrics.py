...
Version(s):
20240515 (1.2.0) --> Update codes to accept ecmwf datasets and format
20240510 (1.1.0) --> Update codes to accept ascat datasets and format
20240503 (1.0.0) --> First development
"""
...
alg_name = 'Application for computing cell metrics'
alg_type = 'Package'
alg_version = '1.2.0'
alg_release = '2024-05-15'
# -------------------------------------------------------------------------------------
