...
from lib_utils_datasets import get_datasets_cell, apply_metrics_datasets_cell, dump_datasets_cell, dump_datasets_grid
            ...
            if self.fx_active:
                ...
                if os.path.exists(file_path_src_def):
                    ...
                    if not os.path.exists(file_path_dst_def):
                        ...
                        # info start apply metrics to datasets cell
                        alg_logger.info(' ------> Apply metrics to datasets ... ')

                        # apply metrics to datasets
                        (collections_dframe_out, registry_dframe_out,
                         collections_attrs_out, registry_attrs_out) = apply_metrics_datasets_cell(
                        ...
                        alg_logger.info(' ------> Apply metrics to datasets ... DONE')
