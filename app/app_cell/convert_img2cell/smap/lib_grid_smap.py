...
def cell_grid(grid_path=None, only_land=False):
    """
    ...
    if grid_path is None:
        grid_folder, grid_file = os.path.dirname(__file__), 'smap_grid.nc'
...
def land_grid(grid_path=None):
    ...
    return cell_grid(only_land=False, grid_path=grid_path)
# -------------------------------------------------------------------------------------
