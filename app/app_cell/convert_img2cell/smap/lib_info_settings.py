...
def parse_data_settings(data_settings):
    ...
    # organize info
    product_args, geo_args, flags_args, path_args, grid_args, time_args, tmpl_args_src, tmpl_args_dst = (
        [product_name],
        [geo_bbox],
        [reset_static, reset_ts],
        [path_grid, path_ts],
        [grid_path],
        [time_start, time_end, time_run],
