...
#-----------------------------------------------------------------------------------------
# Script information
script_name='RECOLOUR - IMG2CELL DR - H26'
...
time_now="2023-11-01 00:00" # complete period

# Time period execution
# "dr :: 1992-01-01 -- 2018-12-31 (from 2008-01-01, 4018 days)"
time_period_days=2500 # fix on zero to provide actual time only, if providing a # days always add 1
#-----------------------------------------------------------------------------------------
