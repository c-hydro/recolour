...
"""
RECOLOUR TOOLS - GLDAS IMG2CELL - REprocess paCkage for sOiL mOistUre pRoducts
...
NOTE:
    "variables": ["SoilMoi0_10cm_inst", "SoilTMP0_10cm_inst", "SWE_inst"] from glda v2.1
    "variables": ["086_L1", "085_L1", "065"] before gldas v2.1
...
from lib_utils_gldas import create_file_grid

from lib_reshuffle_gldas import main as main_runner
# -------------------------------------------------------------------------------------
...
def main_wrapper():
    ...
    create_file_grid(
        ...
        data_ext='.nc4', grid_update=data_settings['flags']['reset_static'])
    # -------------------------------------------------------------------------------------
