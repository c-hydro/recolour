...
Module for a command line interface to convert ECMWF data into a
...
def parse_args(args):
    ...
    parser = argparse.ArgumentParser(
        description="Convert ECMWF data to time series format."
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            " in the ECMWF land mask (faster and less/smaller files)"
        ),
    )
...
def main(args):
    ...
    # info start
    logging.info(
        ' ---> Convert ECMWF datasets from {} to {} into folder {} ... '.format(
    ...
    input_grid = cell_grid(grid_path=args.grid_path, file_grid='grid.nc')
    ...
    # info end
    logging.info(
        ' ---> Convert ECMWF datasets from {} to {} into folder {} ... DONE'.format(
            args.start.isoformat(), args.end.isoformat(), args.dataset_ts_root
        )
    )
# -------------------------------------------------------------------------------------
