...
def interpolate_data(obj_da_in, obj_da_ref,
                     var_name_data='sm', var_name_geo_x='longitude', var_name_geo_y='latitude',
                     coord_name_x='longitude', coord_name_y='latitude', dim_name_x='longitude', dim_name_y='latitude',
...
def resample_points_to_grid(
        file_dframe, geo_x_arr_out, geo_y_arr_out, geo_no_data=np.nan,
